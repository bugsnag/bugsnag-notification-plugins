exports.createNotification = (notificationRow, triggerRow, accountHandle, projectHandle, triggerText, event, error) ->
...
class exports.NotificationBase
    ...
    # Constructor bla bla
    constructor: (@notificationRow, triggerRow, @accountHandle, @projectHandle, @triggerText, @event, @error) ->
